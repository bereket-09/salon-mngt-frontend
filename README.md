...
```
cd existing_repo
git remote add origin https://gitlab.safaricomet.net/vas_dev/sms-trivia/sms-trivia-frontend.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.safaricomet.net/vas_dev/sms-trivia/sms-trivia-frontend/-/settings/integrations)
